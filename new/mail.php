...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    switch ($_POST["id"]) {
        case 'contactForm':
            ...
            $message = '<p>Name: '. htmlspecialchars($_POST["InputName"]).'</p>';
            $message .= '<p>Email: '. htmlspecialchars($_POST["InputEmail"]).'</p>';
            $message .= '<p>Number: '. htmlspecialchars($_POST["InputNumber"]).'</p>';
        ...
        case 'callRequestForm':
            ...
            $message = '<p>Name: '. htmlspecialchars($_POST["InputName"]).'</p>';
            $message .= '<p>Email: '. htmlspecialchars($_POST["InputEmail"]).'</p>';
            $message .= '<p>Freight-Type: '. htmlspecialchars($_POST["freightSelect"]).'</p>';
            $message = '<p>Distance: '. htmlspecialchars($_POST["InputDistance"]).'</p>';
            $message .= '<p>Weight: '. htmlspecialchars($_POST["InputWeight"]).'</p>';
            $message .= '<p>Height: '. htmlspecialchars($_POST["InputHeight"]).'</p>';
            break;    
